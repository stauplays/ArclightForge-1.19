...
public class ModPlacedFeature {
    ...
    public static final RegistryObject<PlacedFeature> ALMANDINE_ORE_PLACED = PLACED_FEATURES.register("almandine_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.OVERWORLD_ALMANDINE_ORE.getHolder().get(), commonOrePlacement(3, // VeinsPerChunk
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(74), VerticalAnchor.aboveBottom(94)))));
