...
import net.verox.arclight.item.client.MoonlightGlaiveRenderer;
...
public class MoonlightGlaiveItem extends SwordItem implements IAnimatable {
    ...
    public MoonlightGlaiveItem(Tier toolMaterial, int attackDamage, float attackSpeed, Properties settings) {
