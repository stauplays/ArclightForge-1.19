...
public class HolyKnightArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<HolyKnightArmorItem>(this, "controller",
                20, this::predicate));
    }
